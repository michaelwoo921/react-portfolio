    ...
    <div>
        ...
        {data.map((school,index) => {
            ...
            <div key={index}>
                 ...
                 <img src={require('../img/' + school.logo)} className="edu__logo" alt="school logo"/>
                    <div className="edu__content"> 
                        <div className="edu__degree"> {school.title}</div>
                        <div className="edu__school"><img src={require('../img/' + school.icon)} alt="degree or certificate" className="edu__school-icon"/>
